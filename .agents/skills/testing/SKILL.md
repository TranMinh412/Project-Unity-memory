...
2.  **Architecture / Tech Spec:** `.specs/features/[feature]/ARCHITECTURE.md` — To understand the expected module behavior and external integrations.
...
*   **Descriptive Naming:** Test names must describe the scenario and expected outcome (e.g., `[Test] public void OnPizzaMerged_ScoreIncreases()`).
...
|----------|-----------------|
| Monobehaviours | Dùng interface và thư viện Mock (như NSubstitute/Moq) hoặc tạo GameObject ảo trong PlayMode |
| Save Data / Config | Tạo file JSON/ScriptableObject giả lập trên RAM thay vì ghi thật vào đĩa |
| Coroutines | Dùng Unity Test Framework `[UnityTest]` và `yield return null;` |
